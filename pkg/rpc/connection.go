...
type ConnectionI interface {
	Connect(ctx context.Context) (RPCConn, error)
	ConnectNoBreaker(ctx context.Context) (RPCConn, error)
	Signal() circuit.Signal
	Health() error
	BatchStreamPool() *streamPool[*kvpb.BatchRequest, *kvpb.BatchResponse, RPCConn]
}
