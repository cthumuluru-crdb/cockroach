...
func TestPartition(t *testing.T) {
	...
	t.Run("test Search with IncludeCentroidDistances", func(t *testing.T) {
		...
		result1 := SearchResult{
			QueryDistance: -12.04, ErrorBound: 3.22, CentroidDistance: -8.45, ParentPartitionKey: 1,
			ChildKey: childKey30, ValueBytes: valueBytes30}
		result2 := SearchResult{
			QueryDistance: -7.07, ErrorBound: 1.61, CentroidDistance: -5.12, ParentPartitionKey: 1,
