...
var builtinOidsArray = []string{
	...
	2983: `crdb_internal.revlog_show_ticks(collection: string) -> tuple{timestamptz AS tick_end, bool AS closed, int AS key_count, int AS logical_bytes, int AS sst_bytes}`,
	2984: `crdb_internal.revlog_show_ticks(collection: string, start: timestamptz, end: timestamptz) -> tuple{timestamptz AS tick_end, bool AS closed, int AS key_count, int AS logical_bytes, int AS sst_bytes}`,
	...
	2998: ``, // removed: superseded by crdb_internal.vector_index_entries
	2999: ``, // removed: superseded by crdb_internal.vector_index_entries
	3000: ``, // removed: superseded by crdb_internal.vector_index_entries
	3001: `crdb_internal.vector_index_entries(table_id: int, index_id: int) -> tuple{int AS level, bool AS is_metadata, jsonb AS decoded_key, jsonb AS decoded_value}`,
}
