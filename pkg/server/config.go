...
type SQLConfig struct {
	// The tenant info that the SQL server runs on the behalf of.
...
func MakeSQLConfig(tenID roachpb.TenantID, tenName roachpb.TenantName, tempStorageCfg base.TempStorageConfig) SQLConfig {
	sqlCfg := SQLConfig{
		TenantID:   tenID,
		TenantName: tenName,
	}
...
func (sqlCfg *SQLConfig) SetDefaults(tempStorageCfg base.TempStorageConfig) {
	tenID, tenName := sqlCfg.TenantID, sqlCfg.TenantName
